...
build-libtorrent:
	./boost_1_74_0/b2 release --user-config=libtorrent/bindings/python/user-config.jam crypto=openssl cxxstd=17 python=3.8 libtorrent-link=static boost-link=static
